...
* **결론 도출:** T cell Exhaustion은 독립적인 상태가 아니라, **"만성적인 활성화(Chronic Activation) 과정에서 기능이 점진적으로 변화하는 연속적인 상태"**임을 시사함

## 📈 주요 결과 (Key Findings)
* **CD52 & DUSP4 Co-expression:** 활성화와 탈진이 공존하는 종양 침윤 T 세포(TIL)의 특성 확인
* **TMSB10 & COTL1:** T 세포의 이동성(Motility) 및 구조적 변화와 관련된 유전자군 발굴
